...
public class parcial6 {
    public static void main(String args[]){
        ...
        paciente p5 = new paciente("irma",200,true);
        paciente p6 = new paciente("javier",200,true);
        a.agendar(p6, 1, 2);
        a.agendar(p1, 2, 2);
        a.agendar(p2, 3, 2);
        a.agendar(p3,4 , 2);
        ...
        a.agendar(p6, 4, 2);
        a.agendar(p6, 1, 5);
        a.liberarTurnos("irma");
       System.out.println( a.tieneTurno("irma", 1));
       System.out.println( a.tieneTurno("javier", 1));
       System.out.println(a.agendarPrimerdia(p6, 3));
       System.out.println(a.agendarPrimerdia(p6, 5));
       System.out.println( a.tieneTurno("irma", 1));
       System.out.println(a.cantidadTurnos("irma"));
       a.liberarDia("irma",1);
       System.out.println(a.cantidadTurnos("irma"));
